...
def process_cti_report(
	...
	def _with_openrouter(name: str | None) -> str | None:
		if not name:
			return None
		l = name.lower()
	...
	ie_model_full = _with_openrouter(ie_model or base_model)
	et_model_full = _with_openrouter(et_model or base_model)
	ea_model_full = _with_openrouter(ea_model or base_embedding_model)
	lp_model_full = _with_openrouter(lp_model or base_model)
